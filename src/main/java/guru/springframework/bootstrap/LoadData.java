...
public class LoadData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public LoadData(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setUrl("http://www.minhrecipe.com");
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("I'm in LoadData class");
    }
}
